...
#   9. Démarre les instances Kubernetes (Nova) si elles sont éteintes
#  10. Démarre Flask (API Backend)
#  11. Valide la connectivité ping + SSH du cluster K8s migré
#  12. Menu interactif de connexion SSH
#  13. Résumé final avec toutes les URLs
# ================================================================
set -uo pipefail
...
# name | nom de l'instance Nova correspondante
...
# ================================================================
#  9. Démarrage des instances Kubernetes (Nova)
# ================================================================
sep "9. Démarrage des instances Kubernetes"
...
echo ""
inf "Pause de 20 secondes pour laisser le temps au réseau/SSH de démarrer dans les VMs..."
sleep 20
pass "Délai de démarrage écoulé"

# ================================================================
#  10. Démarrage Flask (API Backend)
# ================================================================
sep "10. Démarrage Flask API Backend"
...
# ================================================================
#  11. Validation du cluster K8s migré (ping + SSH)
# ================================================================
sep "11. Validation cluster Kubernetes migré (ping + SSH)"
...
#  12. Menu interactif de connexion SSH
# ================================================================
sep "12. Connexion SSH au cluster"
